-----------------------------------------------------------
-- nvim-tree configuration file for Neovim
-- Sets up a file explorer sidebar with icons and git integration.
...
nvim_tree.setup {
  ...
  hijack_netrw = true,  -- netrw already disabled in /core/options.lua
